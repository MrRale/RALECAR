...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Abonos realizados</li>
      </ol>
    </nav>
  </div>
  <div class="card">
    <div class="card-body">
      ...
      <div class="my-5" style="display:flex; flex-direction:row; justify-content:space-between;">
        ...
        <a href="{{route('deuda.abonarProveedor',$deuda->id)}}" class="btn btn-success"> Agregar abono</a>
     
        <h3>Saldo: ${{$deuda->saldo}}</h3>
      </div>
      <div class="row">
        <div class="col-12">
                ...
                <td>{{$c->monto}}</td>
                  ...
                  <td>
                      {{-- <a target="_blank" id="botoncol" title="Generar recibo" href="{{route('admin.pdfAbono',[$c->id,$cliente->id,$saldo])}}" class="btn btn-danger"><li class="fa fa-file-pdf"></li></a>
                       --}}
                      <a target="_blank" id="botoncol" title="Ver comprobante" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal-2"><li class="fas fa-eye"></li></a>

                      <div  class="modal fade" id="exampleModal-2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content" >
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel-2">Imagen del deposito</h5>
