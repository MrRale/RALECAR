...
class PayPalService
{
    ...
    public function handlePayment(Request $request,$pedido)
    {
        $currency="usd";
        $shopping_cart = ShoppingCart::get_the_user_shopping_cart();
        $total_price = $shopping_cart->total_precios();
        //  $total=$request['creditos']*0.20;
         $order = $this->createOrder($total_price, $currency,$pedido);
    ...
    public function createOrder($value, $currency,$pedido)
    {
        ...
        return $this->makeRequest(
            ...
            [
                ...
                'application_context' => [
                    ...
                    'user_action' => 'PAY_NOW',
                    'return_url' => route('compra.pagada',$pedido),
                    'cancel_url' => route('compra.fallida'),
                ]
            ],
            [],
            $isJsonRequest = true,
